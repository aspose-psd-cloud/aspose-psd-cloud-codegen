...
java -jar Tools\openapi-generator-cli-4.3.1.jar generate -i https://api-qa.aspose.cloud/v3.0/imaging/swagger/sdkspec -l csharp -t Templates\csharp -o %sdkfolder% -c config.net.json || goto :error
