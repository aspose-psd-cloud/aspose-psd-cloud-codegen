...
java -jar Tools\swagger-codegen-cli-2.4.5.jar generate -i https://api-qa.aspose.cloud/v3.0/psd/swagger/sdkspec -l csharp -t Templates\csharp -o %sdkfolder% -c config.net.json || goto :error
